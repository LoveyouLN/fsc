...
<html>
	<head>
		...
		<script src="${pageContext.request.contextPath}/static/fqqf/jquery.min.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/static/fqqf/amazeui.min.js" type="text/javascript"></script>
		<link href="${pageContext.request.contextPath}/static/css/amazeui.min.css" type="text/css" rel="stylesheet" />
	   ...
	   <!-- 导航 -->
	    <div class="content-list" id="outer">
	    	<div class="list-left" id="tab">
	    		<li class="current"><a style="position: relative;">新品推荐<span class="am-badge am-badge-danger am-round" id="dwl1">6</span></a></li>
	    	...
	    	<div class="list-right" id="content">
	    		...
	    		<!-- 可以删 -->
	    		<!-- <li><h2 id="dw1">凉菜</h2></li> -->
	    		<!-- <li>ss<textarea id ="name" name="caiming" placeholder="请在这里输入文本"  rows="10" cols="8"></textarea></li> -->
			    	<!-- <li>
			    		<a href="detail.html"><img src="images/1.png" class="list-pic" /></a>
			    		<div class="shop-list-mid">
		                	<div class="tit"><a href="detail.html"></a></div>
		                	<div class="am-gallery-desc">￥55</div>
		                </div>
		                <div class="list-cart">
			                <div class="d-stock">
					                <a class="decrease" name="dwl1">-</a>
					                <input id="num"   class="text_box" name="shu" type="text" value="0">
					                <input  name="qian" type="hidden" value="55">
					                <input  name="name" type="hidden" value="法国加力果">
					                
					                	value多少个   name放钱    title放菜名 
					                <a class="increase" name="dwl1">+</a>
			                </div>
		                </div> 
			    	</li> -->
	    ...
	    <!--底部-->
<form action="text_neirong" method="post">
 <div style="height: 100px;"></div>
 <div class="fix-bot" id="hj">
	   	  <a href="JavaScript:void(0);" class="list-js">合计：<i>0</i>元<em>(0份)</em></a>
	   	
		   	  <input type="submit" style="border:none;margin-top:0px;margin-right:0px;height: 43px" value="选好了" onclick="sumbit()" class="list-jsk"/>
			...
			success:function(data){
				...
				for(var i=0;i<=json.length-1;i++){
					...
					for(var j=0;j<=list.length-1;j++){
						var text =	    	
				    	"<li>"+
				    		"<a href=\"detail.html\"><img src=\""+list[j].imp+"\" class=\"list-pic\"/></a>"+
				    		"<div class=\"shop-list-mid\">"+
			                	"<div class=\"tit\"><a href=\"detail.html\">"+list[j].cai+"</a></div>"+
			                	"<div class=\"am-gallery-desc\">￥"+list[j].qian+"</div>"+
			                "</div>"+
			                "<div class=\"list-cart\">"+
				                "<div class=\"d-stock\">"+
						             "<a class=\"decrease\" name=\"dwl"+json[i].id+"\">-</a>"+
						             "<input class=\"text_box\" name=\"shu\" type=\"text\" value=\"0\">"+
						             "<input name=\"qian\" type=\"hidden\" value=\""+list[j].qian+"\">"+
						             "<input name=\"name\" type=\"hidden\" value=\""+list[j].cai+"\">"+      	
						             "<a class=\"increase\" name=\"dwl"+json[i].id+"\">+</a>"+
				                "</div>"+
				             "</div>"+ 
				           "</li>";
