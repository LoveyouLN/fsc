	...
	$(function(){
		$.ajax({
	        ...
	        /* + 号按钮 */
	             $('.increase').click(function(){
	     			...
	     			console.log(self.siblings('input[name="shu"]').val());
      ...
      function hjj(ss,gs){
       ...
       function sumbit(){
    	   ...
    	   var com=confirm($("#hj input[name='name']").val());
    	   if(com==true){
    		   alert("我要提交喽");
    	   }else{
    		   alert("再选选!");
